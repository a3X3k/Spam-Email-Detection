...
|  Clean the text & add it in new column   |  |  |  | | :heavy_check_mark:
| Text related preprocessing (stop words removal, word stemming). Conversion of text data to numeric (Tf-idf) |  |  |  | | :heavy_check_mark:
